package net.jacob_stewart.tweens 
{
	...
	public class AlphaPulse extends Entity
	{
		...
		public function AlphaPulse(image:Image, alphaHigh:Number = 1, alphaLow:Number = 0, duration:Number = 1, ease:Ease = null, delay:Number = 0)
		{
			this.image = image;
		...
		{
			tween = FP.tween(image, { alpha: getAlphaTo() }, duration, { complete: tweenAlpha, ease: ease, delay: delay } );
		}
